	...
	<div class="wrap">
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					<th style="border-top:0px;" ><label >Reason of Emergency <label></th>
					<td style="border-top:0px;"><input list="q2" class="input-block-level" name="quota" id="q12" value="<?php if(isset($_POST['quota']))echo $_POST['quota'];?>">
					<datalist id="q2" >
					<option value="Personal Family Loss">Personal Family Loss</option>
					<option value="Ailment Reasons">Ailment Reasons</option>
