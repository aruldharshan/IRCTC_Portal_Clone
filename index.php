...
<body>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.php"><style="font size:70pt;>Indian Railways</a>
			</div>
			</div>
		</div>
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<a class="brand" href="top_accomadation.php">TOP ACCOMADATION PROVIDERS</a>
				</div>
			</div>
		</div>
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/img1.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/img2.jpg" style="width:600px;height:350px;"/> </div>
